    ...
    <div className="animate-spring-up">
      <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h2 className="text-4xl font-black text-slate-900 tracking-tight">Service <span className="text-blue-600">Logistics</span></h2>
        </div>

        <div className="flex items-center gap-3 bg-white p-2 rounded-2xl border border-slate-100 shadow-sm">
          <div className="px-4 py-2 border-r border-slate-100">
            <p className="text-[10px] font-black text-slate-600 uppercase tracking-widest">Active Techs</p>
            <p className="text-lg font-black text-slate-900 leading-none mt-1">{technicians.length}</p>
          </div>
          <div className="px-4 py-2">
            <p className="text-[10px] font-black text-slate-600 uppercase tracking-widest">Total Queue</p>
                    ...
                    <tr key={appt._id} className="group hover:bg-slate-50/50 transition-colors">
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-600 group-hover:bg-indigo-600 group-hover:text-white transition-all">
                            <Wrench size={18} />
                          </div>
                          <div>
                      ...
                      <td className="px-6 py-6">
                        ...
                        <p className="text-[10px] font-bold text-slate-600 mt-0.5 italic">{new Date(appt.appointmentDate).toLocaleDateString()}</p>
                      </td>
                      <td className="px-6 py-6">
                      ...
                      <td className="px-6 py-6">
                        <div className="relative inline-block w-48 group/select">
                          ...
                          <ChevronDown size={14} className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-600 pointer-events-none group-hover/select:text-blue-500 transition-colors" />
                        </div>
                      </td>
